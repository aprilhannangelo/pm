...
$adminId= $row['user_id'];
$notifSql = "INSERT INTO notification_t (notification_id,ticket_id, user_id, notification_description, isRead) VALUES(DEFAULT, '$id','$adminId','Ticket No. : $ticketNo has been returned',0)";
