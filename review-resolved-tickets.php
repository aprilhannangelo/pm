          ...
          <div class="count">
            ...
            <?php
              if ($_SESSION['user_type'] == "Administrator"){
                ...
                $query = "SELECT (*) as count FROM user_access_ticket_t uat LEFT JOIN ticket_t t USING(ticked_id) WHERE t.ticket_status=7";
              }
              else if ($_SESSION['user_type'] == "Technicals Group Manager"){
                $query = "SELECT COUNT(*) as count FROM service_ticket_t st LEFT JOIN ticket_t t USING(ticket_id) WHERE t.ticket_status=7";
              }
              else if ($_SESSION['user_type'] == "Network Group Manager"){
                $query = "SELECT COUNT(*) as count FROM ticket_t WHERE ticket_status=7 AND ticket_category='Network'";
              }
              else if ($_SESSION['user_type'] == "Technician"){
                $query = "SELECT COUNT(*) as count FROM service_ticket_t st LEFT JOIN ticket_t t USING(ticket_id) WHERE t.ticket_status=7 AND t.ticket_agent_id = '".$_SESSION['user_id']."'";
              }
              else if ($_SESSION['user_type'] == "Network Engineer"){
                $query = "SELECT COUNT(*) as count FROM user_access_ticket_t uat LEFT JOIN ticket_t t USING(ticket_id) WHERE t.ticket_status=7 AND t.ticket_agent_id = '".$_SESSION['user_id']."'";
              }
          ...
          <div class="actions">
            ...
            <table id="datatable" class="striped">
              ...
              if ($_SESSION['user_type']=='Administrator') {?>
                ...
                <tbody>
                <?php
                   $query = "SELECT * FROM ticket_t WHERE ticket_status=7";
              ...
              elseif ($_SESSION['user_type']=='Access Group Manager') {?>
                ...
                <?php
                $query = "SELECT * FROM user_access_ticket_t uat LEFT JOIN ticket_t t USING(ticket_id) WHERE t.ticket_status=7";
              ...
              elseif ($_SESSION['user_type']=='Technicals Group Manager') {?>
                ...
                <tbody>
                <?php
                  $query = "SELECT * FROM ticket_t t LEFT JOIN service_ticket_t USING (ticket_id) WHERE t.ticket_status=7";
                  $result = mysqli_query($db,$query);?>
              ...
              elseif ($_SESSION['user_type']=='Network Group Manager') {?>
                  ...
                  <tbody>
                  <?php
                  $query = "SELECT * FROM ticket_t t WHERE ticket_category='Network' AND ticket_status=7";
                    $result = mysqli_query($db,$query);?>
              ...
              elseif ($_SESSION['user_type'] == 'Technician') {
                $query = "SELECT * FROM ticket_t t LEFT JOIN service_ticket_t USING (ticket_id) WHERE t.ticket_status=7 AND t.ticket_agent_id = '".$_SESSION['user_id']."'";
                ?>
                <thead>
                  <tr>
                    <th></th>
              ...
              elseif ($_SESSION['user_type'] == 'Network Engineer') {
                $query = "SELECT * FROM ticket_t WHERE ticket_status=7 AND t.ticket_agent_id = '".$_SESSION['user_id']."'";
                 ?>
                 <thead>
                   <tr>
                     <th></th>
